  ...
  protected async init() {
    ...
    this.settings = {
      name: {
        ...
        label: 'name',
        value: '',
        help: 'Name of the memory slot to read; must match the write. <a href="#" target="_blank" class="text-blue-600 hover:text-blue-800">Go to Docs</a>',
      ...
      scope: {
        type: 'select',
        label: 'Scope',
        help: 'Scope to read: session, user, or project. <a href="#" target="_blank" class="text-blue-600 hover:text-blue-800">Go to Docs</a>',
        value: 'Session',
        options: ['Session'],
      },
    };
