      ...
      <div className={`${fullWidth ? 'w-full' : ''}`}>
        ...
        <div className={`relative ${fullWidth ? 'w-full' : 'w-fit'}`}>
          <textarea
            ...
            className={cn(
              'resize-none bg-white border text-gray-900 rounded block w-full outline-none focus:outline-none focus:ring-0 focus:ring-offset-0 focus:ring-shadow-none text-sm font-normal placeholder:text-sm placeholder:font-light py-2 px-3 transition-all duration-150 ease-in-out',
              error
